...
AceEditorComponent.ngFactoryDef = function AceEditorComponent_Factory(t) { return new (t || AceEditorComponent)(ɵngcc0.ɵɵdirectiveInject(ElementRef), ɵngcc0.ɵɵdirectiveInject(NgZone)); };
AceEditorComponent.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: AceEditorComponent, selectors: [["ace-editor"]], inputs: { style: "style", options: "options", readOnly: "readOnly", theme: "theme", mode: "mode", value: "value", text: "text", autoUpdateContent: "autoUpdateContent", durationBeforeCallback: "durationBeforeCallback" }, outputs: { textChanged: "textChanged", textChange: "textChange" }, features: [ɵngcc0.ɵɵProvidersFeature([{
                provide: NG_VALUE_ACCESSOR,
                useExisting: forwardRef(function () { return AceEditorComponent_1; }),
                multi: true
            }])], consts: 0, vars: 0, template: function AceEditorComponent_Template(rf, ctx) { }, styles: ["[_nghost-%COMP%] { display:block;width:100%; }"] });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(AceEditorComponent, [{
        type: Component,
        args: [{
                selector: 'ace-editor',
                template: '',
    ...
    }], function () { return [{ type: ElementRef }, { type: NgZone }]; }, { zone: [], textChanged: [{
            type: Output
        }], textChange: [{
            type: Output
        }], style: [{
            type: Input
        }], _options: [], _readOnly: [], _theme: [], _mode: [], _autoUpdateContent: [], _durationBeforeCallback: [], _text: [], _onChange: [], _onTouched: [], ngOnInit: [], ngOnDestroy: [], init: [], initEvents: [], updateText: [], timeoutSaving: [], oldText: [], options: [{
            type: Input
        }], setOptions: [], readOnly: [{
            type: Input
        }], setReadOnly: [], theme: [{
            ...
            type: Input
        }], value: [], writeValue: [], registerOnChange: [], registerOnTouched: [], text: [{
            type: Input
        }], text: [], setText: [], autoUpdateContent: [{
            type: Input
        }], setAutoUpdateContent: [], durationBeforeCallback: [{
            type: Input
        }], setDurationBeforeCallback: [], getEditor: [] });
