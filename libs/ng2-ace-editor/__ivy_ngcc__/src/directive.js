...
AceEditorDirective.ngFactoryDef = function AceEditorDirective_Factory(t) { return new (t || AceEditorDirective)(ɵngcc0.ɵɵdirectiveInject(ElementRef), ɵngcc0.ɵɵdirectiveInject(NgZone)); };
AceEditorDirective.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: AceEditorDirective, selectors: [["", "ace-editor", ""]], inputs: { options: "options", readOnly: "readOnly", theme: "theme", mode: "mode", text: "text", autoUpdateContent: "autoUpdateContent", durationBeforeCallback: "durationBeforeCallback" }, outputs: { textChanged: "textChanged", textChange: "textChange" } });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(AceEditorDirective, [{
        type: Directive,
        args: [{
                selector: '[ace-editor]'
            }]
            ...
            type: Output
        }], _options: [], _readOnly: [], _theme: [], _mode: [], _autoUpdateContent: [], _durationBeforeCallback: [], _text: [], ngOnInit: [], ngOnDestroy: [], init: [], initEvents: [], updateText: [], timeoutSaving: [], oldText: [], options: [{
            type: Input
        }], readOnly: [{
            type: Input
        }], theme: [{
            ...
            type: Input
        }], setDurationBeforeCallback: [], aceEditor: [] });
